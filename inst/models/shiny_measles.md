...
The **School Selector** feature allows you to quickly populate the vaccination rate and school size using real-world school data:

- **Default Database**: The app includes a sample database of schools from California and Texas. Select a school from the dropdown to automatically populate the parameters.
- **Custom Data**: You can upload your own CSV file with school data. The CSV must contain the following columns:
  - `state`: State name
  - `county`: County name
...
When you select a school from the dropdown, the "Population Size" and "Proportion Vaccinated" fields will be automatically updated with the school's data.
